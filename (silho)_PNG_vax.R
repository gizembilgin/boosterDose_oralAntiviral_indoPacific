#This program is our best guess as to the distribution of doses delivered in Papua New Guinea by age/risk/vaccine type based on government announcements, the Oxford tracker, and UNICEF Market Dashboard
